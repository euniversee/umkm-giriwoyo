    ...
    <div className="bg-white min-h-screen">
      ...
      <header className="container mx-auto px-6 py-5 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          ...
          <Link href="/kontak" className="text-sm font-normal text-[#b4252b]">
            Kontak
          </Link>
        </nav>
        <div className="flex items-center">
          <MobileMenu currentPath="/kontak" />
        </div>
      </header>

      {/* Hero Section */}
      <section className="container mx-auto px-6 pt-16 pb-12">
        <h1 className="text-4xl font-bold text-[#161616] mb-6">Hubungi Kami</h1>
